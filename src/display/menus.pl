 ...
 *
 */
mainMenu:- clearConsole, displayMainMenu, nl, write('What do you want to do?   : '), getInputAndValidate(0, 5, UserChoice), !, handleChoice(UserChoice).
...
handleChoice(5):- clearConsole, displayInstructions, getInputAndValidate(0, 0, _), mainMenu.
